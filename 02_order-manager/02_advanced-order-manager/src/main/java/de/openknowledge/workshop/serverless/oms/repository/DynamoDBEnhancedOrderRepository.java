...
public class DynamoDBEnhancedOrderRepository implements OrderRepository {
    ...
    private static Order optionalUpdateItemInTable(DynamoDbEnhancedClient ddb,
        ...
        try {
            ...
            // TODO
            // - read current version of order via getItemFromTable with ddb and pk
            // - merge current version and order with updates given by method parameter with the help of private merge method
            // - update item (merged order) with the help of the order table object
